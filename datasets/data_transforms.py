...
class PointcloudScaleAndTranslate4Distillation(object):
    def __init__(self, scale_low=2. / 3., scale_high=3. / 2., translate_range=0.2):
        self.scale_low = scale_low
        self.scale_high = scale_high
        self.translate_range = translate_range

    def __call__(self, pc, seeds):
        from .aug_random import AugRandomContext, np_random
        ...
        for i, seed in enumerate(seeds):
            with AugRandomContext(seed=int(seed)):
                ...
                xyz1 = np_random.uniform(low=self.scale_low, high=self.scale_high, size=[3])
                xyz2 = np_random.uniform(low=-self.translate_range, high=self.translate_range, size=[3])
