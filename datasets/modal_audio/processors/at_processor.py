...
import datasets.modal_video.processors.functional_video as F
import datasets.modal_video.processors.transforms_video as lavis_transform
import datasets.modal_video.processors.video_transform_aio as vt
from datasets.modal_audio.processors.util_transforms import (
    SpatialCrop,
...
class ASTProcessorTrain(BaseProcessor):
    ...
    def _wav2fbank(self, filename, filename2=None):
        ...
        # 512
        target_length = self.target_length #self.audio_conf.get("target_length")
